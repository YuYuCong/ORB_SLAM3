...
class TwoViewReconstruction::Impl {
...
TwoViewReconstruction::Impl::Impl(cv::Mat &K,
                                  float sigma,
                                  int iterations) {
  mK = K.clone();
...
bool TwoViewReconstruction::Impl::Reconstruct(const std::vector<cv::KeyPoint> &vKeys1,
                                              const std::vector<cv::KeyPoint> &vKeys2,
  ...
  thread threadH(&TwoViewReconstruction::Impl::FindHomography,
                 this,
                 ref(vbMatchesInliersH),
                 ref(SH),
                 ref(H));
  thread threadF(&TwoViewReconstruction::Impl::FindFundamental,
                 this,
...
void TwoViewReconstruction::Impl::FindHomography(vector<bool> &vbMatchesInliers,
                                                 float &score,
                                                 cv::Mat &H21) {
...
void TwoViewReconstruction::Impl::FindFundamental(vector<bool> &vbMatchesInliers,
                                                  float &score,
                                                  cv::Mat &F21) {
  // Number of putative matches
...
cv::Mat TwoViewReconstruction::Impl::ComputeH21(const vector<cv::Point2f> &vP1,
...
cv::Mat TwoViewReconstruction::Impl::ComputeF21(const vector<cv::Point2f> &vP1,
                                                const vector<cv::Point2f> &vP2) {
  const int N = vP1.size();
...
float TwoViewReconstruction::Impl::CheckHomography(const cv::Mat &H21,
                                                   const cv::Mat &H12,
...
float TwoViewReconstruction::Impl::CheckFundamental(const cv::Mat &F21,
                                                    vector<bool> &vbMatchesInliers,
                                                    float sigma) {
  const int N = mvMatches12.size();
...
bool TwoViewReconstruction::Impl::ReconstructF(vector<bool> &vbMatchesInliers,
                                               cv::Mat &F21,
                                               cv::Mat &K,
                                               cv::Mat &R21,
                                               cv::Mat &t21,
...
bool TwoViewReconstruction::Impl::ReconstructH(vector<bool> &vbMatchesInliers,
                                               cv::Mat &H21,
                                               cv::Mat &K,
                                               cv::Mat &R21,
                                               cv::Mat &t21,
...
void TwoViewReconstruction::Impl::Triangulate(const cv::KeyPoint &kp1,
                                              const cv::KeyPoint &kp2,
                                              const cv::Mat &P1,
                                              const cv::Mat &P2,
                                              cv::Mat &x3D) {
...
void TwoViewReconstruction::Impl::Normalize(const vector<cv::KeyPoint> &vKeys,
...
int TwoViewReconstruction::Impl::CheckRT(const cv::Mat &R,
                                         const cv::Mat &t,
...
void TwoViewReconstruction::Impl::DecomposeE(const cv::Mat &E,
                                             cv::Mat &R1,
                                             cv::Mat &R2,
                                             cv::Mat &t) {
  cv::Mat u, w, vt;
...
bool TwoViewReconstruction::Reconstruct(const std::vector<cv::KeyPoint> &vKeys1,
                                        ...
                                        std::vector<cv::Point3f> &vP3D,
                                        std::vector<bool> &vbTriangulated) {
  return impl_->Reconstruct(vKeys1,
                            vKeys2,
                            vMatches12,
                            R21,
                            t21,
